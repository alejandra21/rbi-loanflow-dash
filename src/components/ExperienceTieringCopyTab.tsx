      ...
      <Tabs defaultValue="external" className="w-full">
        ...
        <TabsContent value="external" className="space-y-4 mt-4">
          <div className="grid grid-cols-2 gap-4">
            <Card>
              <CardHeader>
                <CardTitle className="text-base">Forecasa Metrics</CardTitle>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base">Track Record Document</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
        ...
        <TabsContent value="internal" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Tier Summary</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Weighted Metrics</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Contractor Validation</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
        ...
        <TabsContent value="confidence" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-base">TierLogic Engine</CardTitle>
            </CardHeader>
        ...
        <TabsContent value="enforcement" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Product Enforcement Rules</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
        ...
        <TabsContent value="integration" className="space-y-4 mt-4">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <CardTitle className="text-base">Integration Tracker</CardTitle>
        ...
        <TabsContent value="exceptions" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Exceptions & Tag Manager</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
