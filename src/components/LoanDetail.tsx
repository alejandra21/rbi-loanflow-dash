  ...
  const StatusTimeline = () => {
    ...
    return (
      <div className="mb-6 grid grid-cols-3 gap-6">
        ...
        <div className="space-y-3">
          {/* Phase Reviewed Section - Above Actions */}
          <div className="border rounded-lg p-4 bg-card">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3 flex-1">
                ...
                <span className="font-medium text-sm">Phase Reviewed</span>
                {savedReviewDecision && (
                  <Badge 
                    variant="secondary" 
                    className={`px-3 ${
                      savedReviewDecision === "Unacceptable" || savedReviewDecision === "Suspended" 
                        ? "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400" 
                        : savedReviewDecision === "Acceptable"
              ...
              <StatusBadge status={getCurrentPhase().phase.status} />
            </div>
              ...
              <div className="mt-4 pt-4 border-t space-y-3">
                {savedReviewDecision ? (
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="comment" className="text-sm">Comments (Optional)</Label>
                      <Textarea
                        id="comment"
